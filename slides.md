...
<div class="flex flex-col justify-center h-full max-w-[60%]">
  ...
  <div class="mt-10 flex items-center gap-3 text-white/50 text-xs tracking-wide">
    ...
    <img src="/docs/brand-assets/Rider/Rider-white.svg" class="h-5 inline" />
    <span class="opacity-40">·</span>
    <img src="/docs/brand-assets/Junie/Junie-white.svg" class="h-4 inline" />
    <span class="opacity-40">·</span>
    <img src="/docs/brand-assets/Qodana/Qodana-white.svg" class="h-4 inline" />
    <span class="opacity-40">·</span>
    <img src="/docs/brand-assets/TeamCity/TeamCity-white.svg" class="h-5 inline" />
    <span class="opacity-40">·</span>
...
<div class="grid grid-cols-12 gap-8 h-full items-center">
  <div class="col-span-5">
    <Kicker>Executive Thesis</Kicker>
    <h1 class="!text-[40px] font-extrabold !leading-tight mt-4">
      The Scarcest Resource<br>Has Shifted
    </h1>
    <div class="mt-6 space-y-4 text-[15px] leading-relaxed">
      <p class="text-white/90">❏ The scarcest resource is not generation — it's <Highlight>context and control</Highlight></p>
      <p class="text-white/90">❏ The most expensive task is not writing code — it's getting it right</p>
      <p class="text-white/90">❏ The critical question is not AI chat — it's <Highlight>verified mainline merge</Highlight></p>
    </div>
    <div class="mt-6 text-[14px] text-white/60">
      <TipChip /> AI makes code writing cheaper — it makes context, quality gates, and governance more expensive.
    </div>
  </div>
...
<!--
Use one management-repeatable sentence: AI makes code writing cheaper; it makes context, quality gates, and governance more expensive. This page defines the problem in leadership language.
-->
...
<div class="grid grid-cols-12 gap-8 h-full items-center">
  <div class="col-span-5">
    ...
    <p class="mt-4 text-[15px] text-white/72 leading-relaxed">
      Not a point tool — a complete production-layer hierarchy from personal IDE to organizational governance.
    </p>
    <div class="mt-6 text-[14px] text-white/60">
      <TipChip /> The keyword is "layering," not "product listing."
    </div>
  </div>
  <div class="col-span-7 flex items-center justify-center">
    <StackLayers />
...
<!--
Show the audience that JetBrains already covers from personal development through team delivery to organizational governance. The keyword for this page is layering, not product listing.
-->
...
<div class="grid grid-cols-12 gap-8 h-full items-center">
  <div class="col-span-5">
    ...
    <h1 class="!text-[40px] font-extrabold !leading-tight mt-4">
      Rider = Shared IDE<br>for Human + Agent
    </h1>
    <div class="mt-6 space-y-3 text-[15px] leading-relaxed text-white/90">
      <p>❏ <strong>Shared Context</strong> — both see the same project semantics</p>
      <p>❏ <strong>Shared Tooling</strong> — refactoring, tests, debugger, VCS from the same infrastructure</p>
      <p>❏ <strong>Shared Control</strong> — sensitive actions are auditable, stoppable, and reversible</p>
    </div>
  </div>
  <div class="col-span-7 flex items-center justify-center">
    <SharedIdeHub />
...
<!--
Emphasize the word "shared." The real difference isn't whether you can connect an agent, but whether the agent reuses the IDE's real context and toolchain — not a disconnected copy.
-->
...
<div class="grid grid-cols-12 gap-5 h-full items-center">
  ...
  <div class="col-span-4 flex flex-col justify-center">
    <Kicker>Official Path</Kicker>
    <h1 class="!text-[30px] font-extrabold !leading-tight mt-3 text-white/90">
      ACP + MCP + <img src="/docs/brand-assets/Junie/Junie_icon.svg" class="h-6 inline align-[-4px]" />
    </h1>
    <div class="mt-4 space-y-3 text-[12.5px] leading-relaxed text-white/55">
      <div class="flex gap-2">
        ...
        <p>
          <img src="/docs/brand-assets/AI/AI_icon.svg" class="h-3.5 inline align-[-2px]" />
          <span class="text-white/65 ml-0.5"><b>ACP Registry</b></span>
          — discover &amp; onboard agents inside <b>Rider</b>, no vendor lock-in
        </p>
      </div>
      <div class="flex gap-2">
        <span class="text-white/25 mt-1 text-[10px] flex-shrink-0">●</span>
        <p>
          Reuse
          <img src="/docs/brand-assets/claude.svg" class="h-3.5 inline align-[-2px] ml-0.5" />
          <span class="text-white/65"><b>Claude Code</b></span>
          <span class="text-white/30 mx-1">or</span>
          <img src="/docs/brand-assets/codex.svg" class="h-3 inline align-[-2px]" />
          <span class="text-white/50"><b>Codex</b></span>
      ...
      <div class="flex gap-2">
        <span class="text-white/25 mt-1 text-[10px] flex-shrink-0">●</span>
        <p>
          <span class="text-white/65"><b>Built-in MCP Server</b></span>
          — exposes <img src="/docs/brand-assets/Rider/Rider_icon.svg" class="h-3.5 inline align-[-2px] mx-0.5" /> IDE tools directly to agents
        </p>
      </div>
      <div class="flex gap-2">
        <span class="text-white/25 mt-1 text-[10px] flex-shrink-0">●</span>
        <p>
          <img src="/docs/brand-assets/Junie/Junie_icon.svg" class="h-3.5 inline align-[-2px]" />
          <span class="text-white/65 ml-0.5"><b>Junie</b></span>
          — plan &amp; run complex multi-step tasks with tests and terminal
        </p>
      </div>
    </div>
    <div class="mt-5 text-[12px] text-white/45">
      <StatusChip label="New" /> <span class="ml-1">Rider 2026.1 — optimized agent presets for GameDev</span>
    </div>
  </div>
...
<!--
Don't mix in MCP Steroid here. Make it clear: this is JetBrains official mainline capability — something you can purchase, promote, and govern.
-->
...
<div class="h-full flex flex-col">
  <div class="flex items-center gap-3">
    <Kicker>Frontier Path</Kicker>
    <StatusChip label="Independent Research" />
  </div>
...
<!--
Be sure to verbally emphasize its independent research project status. Use it to stretch imagination, not replace the official path. The IDE can become an agent's skill factory.
-->
...
<div class="h-full flex flex-col">
  <div class="flex items-center gap-3">
    <Kicker>Workflow 4</Kicker>
    <StatusChip label="Quality" />
  </div>
  <h1 class="!text-[40px] font-extrabold !leading-tight mt-3">
    Pre-Merge Quality Gate
  </h1>
  <p class="mt-2 text-[15px] text-white/60">JetBrains doesn't just help write — it helps ship.</p>
  <div class="flex-1 mt-4 flex items-center">
    <QualityGate />
  </div>
  <div class="grid grid-cols-3 gap-4 text-[13px] text-white/70">
    <div><strong class="text-white">Dev-time</strong> — <img src="/docs/brand-assets/Rider/Rider_icon.svg" class="h-4 inline" /> inspections catch issues locally</div>
    <div><strong class="text-white">Team-time</strong> — <img src="/docs/brand-assets/Qodana/Qodana.svg" class="h-3.5 inline" /> brings semantic rules to CI</div>
    <div><strong class="text-white">Ship-time</strong> — <img src="/docs/brand-assets/TeamCity/TeamCity.svg" class="h-3.5 inline" /> runs the pipeline and feedback loop</div>
  </div>
</div>

<!--
Best said to CTOs: the future winner won't be who writes 20% of code via agent, but who dares ship that 20% agent-generated change into mainline with verified quality.
-->
...
<!--
This page switches from "process line" to "role line." Don't pack details — just let the audience know each role sees a different value proposition. The four pages that follow expand on each tier.
-->
...
<div class="h-full flex flex-col">
  <Kicker>Role 1</Kicker>
  <h1 class="!text-[40px] font-extrabold !leading-tight mt-3">
    Gameplay Programmer + Technical Artist
  </h1>
  <div class="flex-1 mt-5">
    <PersonaCards :personas="[
      {title: 'Gameplay Programmer', role: 'Core User', bullets: ['Faster gameplay implementation', 'Stabler debugging cycles', 'Shorter verification loops', 'Engine-aware code generation'], stack: ['Unity', 'Unreal', 'C#', 'C++'], tone: 'cyan'},
      {title: 'Technical Artist', role: 'Core User', bullets: ['Shader & material support', 'In-engine context awareness', 'Visual issue localization', 'Render pipeline debugging'], stack: ['Shader', 'HLSL', 'Materials', 'VFX'], tone: 'pink'}
    ]" />
  </div>
</div>

<!--
These two roles feel immediate efficiency gains. Recommend pairing with a live Unity or Unreal shader/test/debug demo preview. They need engine-context-aware AI, not generic chat assistants.
-->
...
<div class="h-full flex flex-col">
  ...
  <div class="mt-4 text-[14px] text-white/60">
    <TipChip /> For senior engineers, replace "AI productivity" with "lower complex-system change risk."
  </div>
</div>

<!--
The real moat of professional game dev tools shows up most clearly in this role. These engineers don't lack completion — they lack project-wide visibility, dependency transparency, and safe refactoring.
-->
...
<div class="grid grid-cols-12 gap-8 h-full items-center">
  <div class="col-span-5">
    <Kicker>Role 4</Kicker>
    <h1 class="!text-[40px] font-extrabold !leading-tight mt-4">
      R&amp;D Management / CTO
    </h1>
    <p class="mt-4 text-[17px] text-white/80 leading-relaxed italic">
      "Leadership buys not an IDE seat, but an organizational-level software production control plane."
    </p>
    <div class="mt-6 text-[14px] text-white/60">
      <TipChip /> Purchase unit: <strong class="text-white">dotUltimate</strong> — one subscription for the entire .NET &amp; GameDev toolkit.
    </div>
  </div>
  <div class="col-span-7 flex items-center justify-center">
    <ExecutiveGrid />
...
<!--
If your audience is VP/CTO, add: dotUltimate solves seat purchase; the JetBrains ecosystem solves platform standardization. Four outcomes they care about: Standardization, Quality, Governance, Visibility.
-->
...
<div class="grid grid-cols-12 gap-8 h-full items-center">
  <div class="col-span-5">
    <Kicker>Technical Differentiation</Kicker>
    <h1 class="!text-[40px] font-extrabold !leading-tight mt-4">
      Semantic Context Moat
    </h1>
    <div class="mt-6 space-y-3 text-[15px] leading-relaxed text-white/90">
      <p>❏ <strong>Flow / Value Analysis</strong> — trace values along real execution paths</p>
      <p>❏ <strong>Dependency Graph</strong> — visualize change propagation across the project</p>
      <p>❏ <strong>Refactoring Safety</strong> — cross-symbol, cross-type, cross-boundary safe changes</p>
    </div>
    <p class="mt-6 text-[15px] text-white/72 italic">
      LLM sees tokens. <Highlight>Rider sees the codebase as a living system.</Highlight>
    </p>
  </div>
  <div class="col-span-7 flex items-center justify-center">
    <SystemVsToken />
...
<!--
This is the tech moat page. Illustrate with concrete examples: rename across 50 files, safe change signature. These are things no LLM can replicate without IDE-native semantic understanding.
-->
...
<div class="h-full flex flex-col">
  ...
  <p class="mt-2 text-[15px] text-white/60">Not a logo wall — deeply embedded in existing studio workflows.</p>
...
<!--
Avoid a logo wall. Focus on restating "support" as "deeply embedded in existing workflow." Each engine ecosystem — Unreal, Unity, Perforce, Godot — has its own deep integration story.
-->
...
<div class="flex flex-col justify-center items-center h-full text-center">
  <h1 class="!text-[52px] font-extrabold !leading-tight tracking-tight">
    JetBrains Rider is not just<br>where humans code.
  </h1>
  <h2 class="mt-4 !text-[28px] font-bold text-white/80">
    It is where humans and agents<br>build games together.
  </h2>
  <div class="mt-10 flex items-center gap-4 text-[18px] font-semibold tracking-wide text-white/60">
    <span>Context</span>
  ...
  <p class="mt-8 text-[14px] text-white/40">
    Start with a pilot team. Evaluate by workflow — not feature comparison.
  </p>
</div>

<!--
Don't add new information on the final page — only harvest value. The audience should leave repeating one complete sentence: Rider is where humans and agents build games together.
-->
...
<div class="h-full flex flex-col">
  <div class="flex items-center gap-3">
    <Kicker>Appendix A2</Kicker>
    <StatusChip label="Research" />
  </div>
  <h1 class="!text-[40px] font-extrabold !leading-tight mt-3">
  ...
  <p class="text-[13px] text-white/40 italic">Independent research project by Eugene Petrenko · Not an officially supported JetBrains product.</p>
</div>

<!--
Use this page to answer "why not just use Cursor/Claude/Codex" questions. IDE-native access to refactor, inspect, debug, test, and UI state — not just file completion. Always return to the official path.
-->
