...
<template>
  <div class="grid gap-2" :style="{ gridTemplateColumns: `repeat(${steps.length}, minmax(0, 1fr))` }">
    <div
      v-for="(s, i) in steps"
      :key="s.label"
    ...
    >
      ...
      <div v-if="s.detail" class="mt-1 text-[11px] rider-subtle leading-4">{{ s.detail }}</div>
      <span
